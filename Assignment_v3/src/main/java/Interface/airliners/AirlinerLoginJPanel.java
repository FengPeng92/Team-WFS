...
public class AirlinerLoginJPanel extends javax.swing.JPanel {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if ("".equals(username) || "".equals(password)) {
            ...
            if ((txtUsername.getText() == null ? loginAirliner.getUserName() == null : txtUsername.getText().equals(loginAirliner.getUserName())) && (txtPassword.getText() == null ? loginAirliner.getPassword() == null : txtPassword.getText().equals(loginAirliner.getPassword()))) {
