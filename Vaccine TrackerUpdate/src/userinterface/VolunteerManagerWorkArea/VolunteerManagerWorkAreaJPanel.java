...
public class VolunteerManagerWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void agreeBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_agreeBtnActionPerformed
        ...
        if (buttonGroup1.getSelection() != null && buttonGroup2.getSelection() != null && buttonGroup3.getSelection() != null && buttonGroup4.getSelection() != null && buttonGroup5.getSelection() != null) {
            VolunteerApplicationRequest volunteerApplicationRequest = new VolunteerApplicationRequest();
            if (radioAlcoholicNo.isSelected()&&radioAllergicNo.isSelected()&&radioColdNo.isSelected()&&radioSmokingNo.isSelected()) {
                volunteerApplicationRequest.setIsQualified(true);
            } 
        } else {
    ...
    private void disagreeBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_disagreeBtnActionPerformed
        ...
        if (buttonGroup1.getSelection() != null && buttonGroup2.getSelection() != null && buttonGroup3.getSelection() != null && buttonGroup4.getSelection() != null && buttonGroup5.getSelection() != null) {
            VolunteerApplicationRequest volunteerApplicationRequest = new VolunteerApplicationRequest();
            if (radioAlcoholicYes.isSelected()&&radioAllergicYes.isSelected()&&radioColdYes.isSelected()&&radioSmokingYes.isSelected()) {
                volunteerApplicationRequest.setIsQualified(false);
            } 
        } else {
            JOptionPane.showMessageDialog(null, "Please choose an option");
        }
